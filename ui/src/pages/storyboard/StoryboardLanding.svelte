<script>
  ...
  const problemSolutionData = {
    ...
    conclusion:
      "<strong>The result?</strong> Products that users actually want, delivered by teams that know exactly what they're building and why.",
  };
  ...
  const features = [
    {
      ...
      description:
        "Skip the endless spreadsheets. Create story maps that actually show how your product flows from the user's perspective.",
      features: [
    ...
    },
    {
      ...
      description:
        'Whether your team is across the hall or across the globe, everyone stays in sync with real-time collaboration.',
      features: [
    ...
    },
    {
      ...
      description:
        'Transform vague requirements into crystal-clear user stories with all the context your team needs to build with confidence.',
      features: [
  ...
  const finalCtaData = {
    ...
    description:
      'Stop guessing what to build next. Start with story mapping and build products your users will love—backed by data, driven by user needs.',
