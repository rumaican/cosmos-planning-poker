<script>
  ...
  const problemSolutionData = {
    ...
    conclusion:
      '<strong>The difference?</strong> Retrospectives become the engine of improvement, not just another meeting on the calendar.',
  };
  ...
  const features = [
    {
      ...
      description:
        'Move beyond boring retrospectives. Use proven formats that spark meaningful discussions and fresh perspectives.',
      features: [
    ...
    },
    {
      ...
      description:
        'Create psychological safety where introverts contribute as much as extroverts, and honest feedback flows freely.',
      features: [
    ...
    },
    {
      ...
      description:
        'Turn insights into action with accountability that actually works. No more forgotten commitments or repeated discussions.',
      features: [
  ...
  const finalCtaData = {
    ...
    description:
      "Stop wasting time on retrospectives that don't drive change. Start building a culture of continuous improvement that makes your team stronger every sprint.",
